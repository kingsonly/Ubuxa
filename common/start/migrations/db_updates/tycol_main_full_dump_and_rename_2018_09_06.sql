...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2018 at 09:44 AM
...
DROP DATABASE IF EXISTS `premux_main`;
CREATE DATABASE IF NOT EXISTS `premux_main` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `premux_main`;
...
--
-- Creation: Aug 12, 2018 at 05:05 AM
--

DROP TABLE IF EXISTS `tm_access_permission`;
...
--
-- Dumping data for table `tm_access_permission`
--

INSERT INTO `tm_access_permission` (`action`, `access_value`, `type`) VALUES
('create', 2, 'action'),
('delete', 8, 'action'),
('index', 1, 'action'),
('see_all', 16, 'other'),
...
DROP TABLE IF EXISTS `tm_asset_attribute`;
...
DROP TABLE IF EXISTS `tm_component_manager`;
...
DROP TABLE IF EXISTS `tm_component_task`;
...
DROP TABLE IF EXISTS `tm_component_types`;
...
--
-- Dumping data for table `tm_component_types`
--

INSERT INTO `tm_component_types` (`component_name`, `component_simplename`, `component_classname`, `component_junction_model`, `junction_foreign_key`) VALUES
('Correspondence', 'correspondence', 'app\\models\\Correspondence', 'app\\models\\CorrespondenceComponent', 'correspondence_id'),
('Edocument', 'edocument', 'app\\models\\Edocument', 'app\\models\\EdocumentComponent', 'edocument_id'),
('Invoice', 'invoice', 'app\\models\\Invoice', 'app\\models\\InvoiceComponent', 'invoice_id'),
('Order', 'order', 'app\\models\\Order', 'app\\models\\OrderComponent', 'order_number'),
('Payment', 'payment', 'app\\models\\Payment', 'app\\models\\PaymentComponent', 'payment_id'),
('Project', 'project', 'app\\models\\Project', 'app\\models\\ProjectComponent', 'project_id'),
('Receivedpurchaseorder', 'receivedpurchaseorder', 'app\\models\\Receivedpurchaseorder', 'app\\models\\ReceivedpurchaseorderComponent', 'receivedpurchaseorder_reference');
...
DROP TABLE IF EXISTS `tm_correspondence`;
...
DROP TABLE IF EXISTS `tm_correspondence_component`;
...
INSERT INTO `tm_country` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
--
-- Dumping data for table `tm_currency`
--

INSERT INTO `tm_currency` (`id`, `country`, `currency_code`, `currency_title`, `symbol`, `unit_text`, `subunit_text`) VALUES
(1, 'Albania', 'ALL', 'Leke', 'L', NULL, NULL),
(2, 'America', 'USD', 'Dollars', '$', NULL, NULL),
(3, 'Afghanistan', 'AFN', 'Afghanis', '؋', NULL, NULL),
(4, 'Argentina', 'ARS', 'Pesos', '$', NULL, NULL),
(5, 'Aruba', 'AWG', 'Guilders', 'ƒ', NULL, NULL),
(6, 'Australia', 'AUD', 'Dollars', '$', NULL, NULL),
(7, 'Azerbaijan', 'AZN', 'New Manats', 'м', NULL, NULL),
(8, 'Bahamas', 'BSD', 'Dollars', '$', NULL, NULL),
(9, 'Barbados', 'BBD', 'Dollars', '$', NULL, NULL),
(10, 'Belarus', 'BYR', 'Rubles', 'p', NULL, NULL),
(11, 'Belgium', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(12, 'Beliz', 'BZD', 'Dollars', 'B', NULL, NULL),
(13, 'Bermuda', 'BMD', 'Dollars', '$', NULL, NULL),
(14, 'Bolivia', 'BOB', 'Bolivianos', '$', NULL, NULL),
(15, 'Bosnia and Herzegovina', 'BAM', 'Convertible Marka', 'K', NULL, NULL),
(16, 'Botswana', 'BWP', 'Pula\'s', 'P', NULL, NULL),
(17, 'Bulgaria', 'BGN', 'Leva', 'л', NULL, NULL),
(18, 'Brazil', 'BRL', 'Reais', 'R', NULL, NULL),
(19, 'Britain (United Kingdom)', 'GBP', 'Pounds', '£', NULL, NULL),
(20, 'Brunei Darussalam', 'BND', 'Dollars', '$', NULL, NULL),
(21, 'Cambodia', 'KHR', 'Riels', '៛', NULL, NULL),
(22, 'Canada', 'CAD', 'Dollars', '$', NULL, NULL),
(23, 'Cayman Islands', 'KYD', 'Dollars', '$', NULL, NULL),
(24, 'Chile', 'CLP', 'Pesos', '$', NULL, NULL),
(25, 'China', 'CNY', 'Yuan Renminbi', '¥', NULL, NULL),
(26, 'Colombia', 'COP', 'Pesos', '$', NULL, NULL),
(27, 'Costa Rica', 'CRC', 'Colón', '₡', NULL, NULL),
(28, 'Croatia', 'HRK', 'Kuna', 'k', NULL, NULL),
(29, 'Cuba', 'CUP', 'Pesos', '₱', NULL, NULL),
(30, 'Cyprus', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(31, 'Czech Republic', 'CZK', 'Koruny', 'K', NULL, NULL),
(32, 'Denmark', 'DKK', 'Kroner', 'k', NULL, NULL),
(33, 'Dominican Republic', 'DOP ', 'Pesos', 'R', NULL, NULL),
(34, 'East Caribbean', 'XCD', 'Dollars', '$', NULL, NULL),
(35, 'Egypt', 'EGP', 'Pounds', '£', NULL, NULL),
(36, 'El Salvador', 'SVC', 'Colones', '$', NULL, NULL),
(37, 'England (United Kingdom)', 'GBP', 'Pounds', '£', NULL, NULL),
(38, 'Euro', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(39, 'Falkland Islands', 'FKP', 'Pounds', '£', NULL, NULL),
(40, 'Fiji', 'FJD', 'Dollars', '$', NULL, NULL),
(41, 'France', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(42, 'Ghana', 'GHC', 'Cedis', '¢', NULL, NULL),
(43, 'Gibraltar', 'GIP', 'Pounds', '£', NULL, NULL),
(44, 'Greece', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(45, 'Guatemala', 'GTQ', 'Quetzales', 'Q', NULL, NULL),
(46, 'Guernsey', 'GGP', 'Pounds', '£', NULL, NULL),
(47, 'Guyana', 'GYD', 'Dollars', '$', NULL, NULL),
(48, 'Holland (Netherlands)', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(49, 'Honduras', 'HNL', 'Lempiras', 'L', NULL, NULL),
(50, 'Hong Kong', 'HKD', 'Dollars', '$', NULL, NULL),
(51, 'Hungary', 'HUF', 'Forint', 'F', NULL, NULL),
(52, 'Iceland', 'ISK', 'Kronur', 'k', NULL, NULL),
(53, 'India', 'INR', 'Rupees', 'R', NULL, NULL),
(54, 'Indonesia', 'IDR', 'Rupiahs', 'R', NULL, NULL),
(55, 'Iran', 'IRR', 'Rials', '﷼', NULL, NULL),
(56, 'Ireland', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(57, 'Isle of Man', 'IMP', 'Pounds', '£', NULL, NULL),
(58, 'Israel', 'ILS', 'New Shekels', '₪', NULL, NULL),
(59, 'Italy', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(60, 'Jamaica', 'JMD', 'Dollars', 'J', NULL, NULL),
(61, 'Japan', 'JPY', 'Yen', '¥', NULL, NULL),
(62, 'Jersey', 'JEP', 'Pounds', '£', NULL, NULL),
(63, 'Kazakhstan', 'KZT', 'Tenge', 'л', NULL, NULL),
(64, 'Korea (North)', 'KPW', 'Won', '₩', NULL, NULL),
(65, 'Korea (South)', 'KRW', 'Won', '₩', NULL, NULL),
(66, 'Kyrgyzstan', 'KGS', 'Soms', 'л', NULL, NULL),
(67, 'Laos', 'LAK', 'Kips', '₭', NULL, NULL),
(68, 'Latvia', 'LVL', 'Lati', 'L', NULL, NULL),
(69, 'Lebanon', 'LBP', 'Pounds', '£', NULL, NULL),
(70, 'Liberia', 'LRD', 'Dollars', '$', NULL, NULL),
(71, 'Liechtenstein', 'CHF', 'Switzerland Francs', 'C', NULL, NULL),
(72, 'Lithuania', 'LTL', 'Litai', 'L', NULL, NULL),
(73, 'Luxembourg', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(74, 'Macedonia', 'MKD', 'Denars', 'д', NULL, NULL),
(75, 'Malaysia', 'MYR', 'Ringgits', 'R', NULL, NULL),
(76, 'Malta', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(77, 'Mauritius', 'MUR', 'Rupees', '₨', NULL, NULL),
(78, 'Mexico', 'MXN', 'Pesos', '$', NULL, NULL),
(79, 'Mongolia', 'MNT', 'Tugriks', '₮', NULL, NULL),
(80, 'Mozambique', 'MZN', 'Meticais', 'M', NULL, NULL),
(81, 'Namibia', 'NAD', 'Dollars', '$', NULL, NULL),
(82, 'Nepal', 'NPR', 'Rupees', '₨', NULL, NULL),
(83, 'Netherlands Antilles', 'ANG', 'Guilders', 'ƒ', NULL, NULL),
(84, 'Netherlands', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(85, 'New Zealand', 'NZD', 'Dollars', '$', NULL, NULL),
(86, 'Nicaragua', 'NIO', 'Cordobas', 'C', NULL, NULL),
(87, 'Nigeria', 'NGN', 'Nairas', '₦', NULL, NULL),
(88, 'North Korea', 'KPW', 'Won', '₩', NULL, NULL),
(89, 'Norway', 'NOK', 'Krone', 'k', NULL, NULL),
(90, 'Oman', 'OMR', 'Rials', '﷼', NULL, NULL),
(91, 'Pakistan', 'PKR', 'Rupees', '₨', NULL, NULL),
(92, 'Panama', 'PAB', 'Balboa', 'B', NULL, NULL),
(93, 'Paraguay', 'PYG', 'Guarani', 'G', NULL, NULL),
(94, 'Peru', 'PEN', 'Nuevos Soles', 'S', NULL, NULL),
(95, 'Philippines', 'PHP', 'Pesos', 'P', NULL, NULL),
(96, 'Poland', 'PLN', 'Zlotych', 'z', NULL, NULL),
(97, 'Qatar', 'QAR', 'Rials', '﷼', NULL, NULL),
(98, 'Romania', 'RON', 'New Lei', 'l', NULL, NULL),
(99, 'Russia', 'RUB', 'Rubles', 'р', NULL, NULL),
(100, 'Saint Helena', 'SHP', 'Pounds', '£', NULL, NULL),
(101, 'Saudi Arabia', 'SAR', 'Riyals', '﷼', NULL, NULL),
(102, 'Serbia', 'RSD', 'Dinars', 'Д', NULL, NULL),
(103, 'Seychelles', 'SCR', 'Rupees', '₨', NULL, NULL),
(104, 'Singapore', 'SGD', 'Dollars', '$', NULL, NULL),
(105, 'Slovenia', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(106, 'Solomon Islands', 'SBD', 'Dollars', '$', NULL, NULL),
(107, 'Somalia', 'SOS', 'Shillings', 'S', NULL, NULL),
(108, 'South Africa', 'ZAR', 'Rand', 'R', NULL, NULL),
(109, 'South Korea', 'KRW', 'Won', '₩', NULL, NULL),
(110, 'Spain', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(111, 'Sri Lanka', 'LKR', 'Rupees', '₨', NULL, NULL),
(112, 'Sweden', 'SEK', 'Kronor', 'k', NULL, NULL),
(113, 'Switzerland', 'CHF', 'Francs', 'C', NULL, NULL),
(114, 'Suriname', 'SRD', 'Dollars', '$', NULL, NULL),
(115, 'Syria', 'SYP', 'Pounds', '£', NULL, NULL),
(116, 'Taiwan', 'TWD', 'New Dollars', 'N', NULL, NULL),
(117, 'Thailand', 'THB', 'Baht', '฿', NULL, NULL),
(118, 'Trinidad and Tobago', 'TTD', 'Dollars', 'T', NULL, NULL),
(119, 'Turkey', 'TRY', 'Lira', 'T', NULL, NULL),
(120, 'Turkey', 'TRL', 'Liras', '£', NULL, NULL),
(121, 'Tuvalu', 'TVD', 'Dollars', '$', NULL, NULL),
(122, 'Ukraine', 'UAH', 'Hryvnia', '₴', NULL, NULL),
(123, 'United Kingdom', 'GBP', 'Pounds', '£', 'pounds', 'pence'),
(124, 'United States of America', 'USD', 'Dollars', '$', 'dollars', 'cents'),
(125, 'Uruguay', 'UYU', 'Pesos', '$', NULL, NULL),
(126, 'Uzbekistan', 'UZS', 'Sums', 'л', NULL, NULL),
(127, 'Vatican City', 'EUR', 'Euro', '€', 'Euros', 'Cents'),
(128, 'Venezuela', 'VEF', 'Bolivares Fuertes', 'B', NULL, NULL),
(129, 'Vietnam', 'VND', 'Dong', '₫', NULL, NULL),
(130, 'Yemen', 'YER', 'Rials', '﷼', NULL, NULL),
(131, 'Zimbabwe', 'ZWD', 'Zimbabwe Dollars', 'Z', NULL, NULL);
...
DROP TABLE IF EXISTS `tm_device_access_token`;
...
DROP TABLE IF EXISTS `tm_e_document`;
...
DROP TABLE IF EXISTS `tm_e_document_component`;
...
CREATE TABLE IF NOT EXISTS `tm_folder_component` (
  ...
  `component_id` int(11) NOT NULL,
  UNIQUE KEY `folder_id` (`folder_id`,`component_id`),
...
DROP TABLE IF EXISTS `tm_folder_manager`;
CREATE TABLE IF NOT EXISTS `tm_folder_manager` (
  ...
  KEY `ReverseFM` (`user_id`,`folder_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tm_folder_task`;
CREATE TABLE IF NOT EXISTS `tm_folder_task` (
  `folder_id` int(11) NOT NULL,
  `task_id` int(11) NOT NULL,
  UNIQUE KEY `folder_id` (`folder_id`,`task_id`),
  KEY `TaskFolder` (`folder_id`),
...
CREATE TABLE IF NOT EXISTS `tm_migration` (
...
CREATE TABLE IF NOT EXISTS `tm_order` (
  ...
  KEY `folder_id` (`folder_id`,`supplier_id`,`supplier_ref`),
...
DROP TABLE IF EXISTS `tm_payment_component`;
...
(1, 'Demonstration', 'Demo', '2017-06-05 00:00:00', 1, '2017-06-05 00:00:00', 33),
(2, 'Ayke A', 'Okechukwu', '2017-09-05 00:00:00', 2, '0000-00-00 00:00:00', 33),
(3, 'Ayke A', 'Okechukwu', '0000-00-00 00:00:00', 3, '0000-00-00 00:00:00', 33),
(48, 'guest', 'guesst', '0000-00-00 00:00:00', 95, '0000-00-00 00:00:00', 33),
(49, 'Gabriel Nnameka', 'Onike', '0000-00-00 00:00:00', 96, '0000-00-00 00:00:00', 33);
...
DROP TABLE IF EXISTS `tm_reminder`;
...
INSERT INTO `tm_role` (`id`, `name`, `access_level`, `cid`) VALUES
(1, 'admin', 15, NULL),
(2, 'manager', 15, NULL),
(3, 'administrator', 7, NULL),
(4, 'field_officer', 5, NULL),
(5, 'data_entry', 3, NULL);
...
--
-- Dumping data for table `tm_state`
--

INSERT INTO `tm_state` (`id`, `name`, `country_id`) VALUES
...
--
-- Dumping data for table `tm_status_type`
--

INSERT INTO `tm_status_type` (`id`, `status_group`, `status_title`) VALUES
(1, 'project', 'Getting Quotes'),
(2, 'project', 'Preparing Quotation'),
(5, 'project', 'Quotation Sent'),
(6, 'device', 'Awaiting Approval'),
(7, 'device', 'Approved'),
(8, 'device', 'Banned'),
(9, 'order', 'Awaiting Approval'),
(10, 'order', 'Order Sent'),
(11, 'order', 'Order Acknowledged'),
(12, 'order', 'Awaiting Payment'),
(13, 'order', 'Delivered'),
(14, 'order', 'Cancelled'),
(15, 'invoice', 'Awaiting Payment'),
(16, 'invoice', 'Paid'),
(17, 'invoice', 'Cancelled'),
(18, 'project', 'Cancelled'),
(19, 'project', 'Awaiting Payment'),
(20, 'project', 'Paid'),
(21, 'task', 'Not Started'),
(22, 'task', 'In Progress'),
(23, 'task', 'Cancelled'),
...
DROP TABLE IF EXISTS `tm_task_reminder`;
...
DROP TABLE IF EXISTS `tm_user_device`;
...
DROP TABLE IF EXISTS `tm_user_route_access`;
...
--
-- Table structure for table `tm_user_setting`
--
-- Creation: Aug 12, 2018 at 05:05 AM
--

DROP TABLE IF EXISTS `tm_user_setting`;
CREATE TABLE IF NOT EXISTS `tm_user_setting` (
  `id` bigint(19) NOT NULL,
  `logo` varchar(255) NOT NULL COMMENT 'This should point to a location',
  `theme` varchar(255) NOT NULL,
  `language` varchar(255) NOT NULL COMMENT 'should use ISO languages',
  `date_format` varchar(255) NOT NULL COMMENT 'also use ISO format?',
  `tm_user_setting_id` int(11) NOT NULL,
  UNIQUE KEY `id_2` (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `tm_folder_component`
  ADD CONSTRAINT `ComponentFolders` FOREIGN KEY (`folder_id`) REFERENCES `tm_folder` (`id`) ON UPDATE CASCADE,
...
ALTER TABLE `tm_folder_manager`
  ADD CONSTRAINT `FolderItem` FOREIGN KEY (`folder_id`) REFERENCES `tm_folder` (`id`),
...
ALTER TABLE `tm_folder_task`
  ...
  ADD CONSTRAINT `TaskFolder` FOREIGN KEY (`folder_id`) REFERENCES `tm_folder` (`id`);
...
ALTER TABLE `tm_remark`
  ADD CONSTRAINT `RemarkFolder` FOREIGN KEY (`folder_id`) REFERENCES `tm_folder` (`id`) ON UPDATE CASCADE;
