...
--
-- Database: `premux_main_customer`
--
DROP DATABASE IF EXISTS `premux_main_customers`;
DROP DATABASE IF EXISTS `premux_main_customer`;
DROP DATABASE IF EXISTS `tycol_main_customers`;
DROP DATABASE IF EXISTS `tycol_main_customer`;
CREATE DATABASE IF NOT EXISTS `premux_main_customer` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `premux_main_customer`;
