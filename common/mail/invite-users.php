...
$inviteLink = $link;//Yii::$app->urlManager->createAbsoluteUrl(['site/invite','email' => $email,'cid' => $user->cid, 'role' => $role]);
?>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                  <p style="margin: 0;"><h3>Join <?= Html::encode($user->first_name.' '.$user->last_name) ?> on Ubuxa</h3></p>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              <td align="center" style="border-radius: 3px;" bgcolor="#264787">
								  <a href="<?= $inviteLink;?>" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #264787; display: inline-block;">Click on link to complete your registration</a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480" >
                ...
                <tr>
                  <td bgcolor="#111111" align="left" style="padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                    <p style="margin: 0;"><a style="cursor: pointer;" href="<?= $inviteLink;?>"><?=  $inviteLink;?></a></p>
                  </td>
                </tr>
            </table>
        </td>
