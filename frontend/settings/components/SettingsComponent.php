	...
	public function boffinsLoaderImage($size = 'sm', $type = 'image')
	{
		if($type == 'image'){
			if($size == 'sm'){
				...
				return '<img  style="height: 40px;width: 40px;margin:3px 5px 3px 25px" src="'.Url::to("@web/images/loader/loadermd.gif").'" />';
			}elseif($size == 'lg'){
				return '<img  style="height: 40px;width: 40px;margin:3px 5px 3px 25px" src="'.Url::to("@web/images/loader/loaderlg.gif").'" />';
			}else{
				return '<img  style="height: 40px;width: 40px;margin:3px 5px 3px 25px" src="'.Url::to("@web/images/loader/loader.gif").'" />';
			}
		}elseif($type == 'link'){
