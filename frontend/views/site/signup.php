...
<?php }else{?>
  <?= ErrorPageWidget::widget(['errorHeader' => '404', 'contentHeader' => 'We got an error', 'content' => 'It seems like this email address already exist', 'button' => 'BACK TO LOGIN', 'url' => $login]); ?>
<?php }?>
