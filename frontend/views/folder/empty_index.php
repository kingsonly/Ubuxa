...
.signals--wave {
  ...
  -webkit-animation-name: signals;
          animation-name: signals;
...
@media (max-width:1168px) and (min-width:997px) {
 ...
 @media (max-width:996px) and (min-width:744px) {
 ...
 @media (max-width:743px) and (min-width:700px) {
...
<section>
       <div class="row">
            ...
            <button class="btn btn-default" style="display:none"><a href="<?= Url::to(['site/logout'])?>">Logout</a></button>
       			<table style="width:100%;height: 100%">
       					<tr style="">
       						<td style=""></td>
       						<td style="text-align:center">
       							<div style=" width: 100%; height: 100%">
                       <div class="beacon-wrappers">
                          <span class="signals beacon--epicentres" style="display:none"></span>
                          <span class="signals signals--wave"></span>
                          <span class="signals signals--wave signals--delay"></span>
                        </div>
         							<div class="centered">
                        ...
                        <div class="plus" id="plus">
                          ...
                          <?= FolderCreateWidget::widget(['newFolderCreated' => 0]);?>
                        </div>
                          ...
                          <div class="plus__line plus__line--h" id = "plus__line--h"></div>
       						...
       						<td style="" class="logout-btn-index"></td>
       					</tr>
       			</table>
       		</div>
       </div>
...
$indexJs = <<<JS
 ...
 function plusToggle() {
    ...
    if($('.empty_index_folder_create').hasClass('shown')){
      ...
      $('.beacon-wrappers').show();
    } else {
      $('.beacon-wrappers').hide();
