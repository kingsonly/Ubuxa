   ...
   ?>
    ...
    <div class="accordion-header js-accordion-header feedify-item-header"><?= $firstKey;?></div> 
		...
		<div class="col-lg-3 col-md-4 col-sm-6 col-xs-6" style="padding: 20px;">
			<?//= EdocumentWidget::widget(['docsize'=>100,'target'=>'foldervault'.$newactualfolder->id, 'textPadding'=>25,'referenceID'=>$newactualfolder->id,'reference'=>'folder','iconPadding'=>0, 'edocument' => 'dropzone']);?>
