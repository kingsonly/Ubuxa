		...
		<nav class="navbar navbar-static-top">
			<div class="container">
				<div class="navbar-header">
					...
					<img src="../web/images/logo1.png" style="height: 50px;width: 50px;margin:3px 5px 3px 25px">
					<?= Html::img('@web/images/male.png', ['alt' => 'logo', 'class' => 'img-circle','style'=>"height: 50px;width: 50px;margin:3px 5px 3px 25px" ]); ?>
