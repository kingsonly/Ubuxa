...
return [
	...
	'as beforeRequest' => [
		...
		'rules' => [
			[
				'allow' => true,
				'actions' => ['login','customersignup','signup', 'ajax-validate-form', 'ajax-validate-user-form', 'request-password-reset','ajax-validate-request-password-form','reset-password', 'signin','find-workspace'],
				'roles' => ['?'],
			],
			[
				'allow' => true,
