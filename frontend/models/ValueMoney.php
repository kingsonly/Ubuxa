 ...
 */
class ValueMoney extends ValueARModel implements ValueInterface, Sortable
{
    /**
     * {@inheritdoc}
     */
	...
	public function setValue($value)
	{
		if (empty($value) || !is_numeric($value)) {
			...
			Yii::warning("Setting an unnaceptable value. Must be numeric. {$errorVal} was given. Setting to null.");
	...
	{
		return [
			'data_info' => 'DECIMAL: ' . mb_strlen($this->value),
			'value' => $this->value,
		];
	}
}
